        ...
        {!loading && trackedGames.length === 0 ? (
          ...
          <div className="space-y-4">
            {trackedGames.map((game) => (
              <div key={game._id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        {game.lastKnownVersion && (
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            Last Version: {game.lastKnownVersion}
                          </p>
                        )}
                      </div>
                      ...
                      <button
                        ...
                        className="px-3 py-1 bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 text-sm rounded hover:bg-red-200 dark:hover:bg-red-800"
                      >
                        Untrack
                      </button>
                    </div>
                      ...
                      <div className="mt-4">
                        ...
                        <div className="space-y-2">
                          {game.updateHistory.slice(0, 3).map((update, updateIndex) => (
                            <div key={updateIndex} className="text-sm bg-blue-50 dark:bg-blue-900/20 p-2 rounded">
                              <div className="flex items-start justify-between">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="space-y-2">
                          {game.pendingUpdates.slice(0, 3).map((update) => (
                            <div key={update._id} className="text-sm bg-yellow-50 dark:bg-yellow-900/20 p-2 rounded">
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
